...
class TestAdam(unittest.TestCase):
    ...
    def test_adam_step(self):
        ...
        optimizer = Adam(mlp4, lr=self.lr, beta1=self.beta1, beta2=self.beta2, eps=self.eps)
        ...
        # Expected outputs
        with open(f"{pkl_dir}/adam_sol_W.pkl", "rb") as f:
            sol_W = pickle.load(f)
        with open(f"{pkl_dir}/adam_sol_b.pkl", "rb") as f:
            sol_b = pickle.load(f)
